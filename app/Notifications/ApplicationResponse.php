    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'links' => [
                ...
                'accept_offer' => $this->application->central_services_approval_status == 'accepted' ? '/attachee/offer-acceptance/' . $this->application->id : null,
            ],
        ];
    }
...
//             'offer_acceptance_form' => $this->application->central_services_approval_status == 'accepted' ? env('APP_URL') . '/attachee/offer-acceptance-form/' . $this->application->id : null,
//             'offer_acceptance_form_upload_link' => $this->application->central_services_approval_status == 'accepted' ? env('APP_URL') . '/attachee/offer-acceptance-form-upload/' . $this->application->id : null,
//         ],
//     ]);
// }
