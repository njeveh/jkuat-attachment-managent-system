    ...
    <form class="mt-3" wire:submit.prevent="createAdvert">
        ...
        <div class="container">
            ...
            <div class="form-group flex-column mb-3">
                <label for="advert-year">{{ __('Year (select year):') }}</label>
            ...
            <div class="w-100 d-flex justify-content-end align-content-center pb-3">
                <button class="w-100 btn btn-primary mb-3" type="submit">{{ __('Submit') }}</button>
            </div>
        </div>
    </form>
