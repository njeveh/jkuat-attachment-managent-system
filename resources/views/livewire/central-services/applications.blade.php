                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-md">                          
                                                    <a href={{ route('central_services.application_details', $application->id) }} class="btn btn-success">View</a>
                                                    @if ($application->central_services_approval_status == 'pending')
                                                        <button class="btn btn-primary" wire:click="warn('accept', '{{ $application->id }}')"
                                                            {{ $application->department_approval_status == 'pending' || $application->department_approval_status == 'rejected' ? 'disabled' : '' }}>

                                                            Accept
                                                        </button>
                                                        <button wire:click="warn('reject', '{{ $application->id }}')" class="btn btn-danger" {{ $application->department_approval_status == 'pending'? 'disabled' : '' }}>

                                                            Reject
                                                        </button>
                                                    @endif
                                                    @if ($application->central_services_approval_status == 'accepted')
                                                    <button class="btn btn-danger" data-bs-toggle="collapse" data-bs-target="#revocation-form-{{ $application->id }}"
