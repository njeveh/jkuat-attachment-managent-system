                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-md">
                                            <a href={{ route('departments.view_application_details', $application->id) }} class="btn btn-success">View</a>
                                            ...
                                            <button wire:click="warn('reject', '{{ $application->id }}')" class="btn btn-danger">
                                                Reject
                                            </button>
                                            @endif
                                            @if ($application->central_services_approval_status == 'accepted')
                                            <button class="btn btn-danger" data-bs-toggle="collapse" data-bs-target="#revocation-form-{{ $application->id }}">Revoke</button>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
