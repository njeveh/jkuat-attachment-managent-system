                            ...
                            <table class="table table-sm table-responsive table-bordered table-striped my-2">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class="custom-border" scope="col">Dismissed before Completion</th>
                                ...
                                <tbody>
                                    @foreach ($adverts as $key => $advert)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $number_of_applicants_dismissed_before_completion }}</td>
